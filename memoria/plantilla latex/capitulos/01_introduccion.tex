...
concepto a un instrumento físico autónomo a microcontroladores
de bajo coste que generen el audio en su propio hardware y respondan a un gesto
táctil y a un teclado MIDI sin necesidad de un ordenador conectado. La
...
oportunidad para poder aplicar muy transversalmente todos los conocimientos
...
control y una entrada MIDI estándar para la ejecución musical.
...
\begin{itemize}
    ...
    \item Incorporar el control de nota y dinámica mediante MIDI, así como un
...
genera el audio gracias a su DAC de 24 bits. El teclado que proporciona las notas se conecta por MIDI DIN y
...
\begin{itemize}
    ...
    \item \textbf{El espacio latente es bidimensional.} Esta elección viene
          ...
          se discute en el capítulo de resultados.
...
resto del documento y revisa los trabajos previos relacionados, tanto los
sistemas de síntesis neuronal publicados.
...
preprocesado del corpus de formas de onda hasta el entrenamiento del
